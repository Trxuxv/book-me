...
export class AppMenuComponent implements OnInit {
    ...
    ngOnInit() {
        this.model = [
            ...
            { label: 'Perfil', routerLink: ['/uikit/media'] , items:[
                
                { label: 'Info', routerLink: ['/uikit/media'] },
                { label: 'Jogos favoritos', routerLink: ['/uikit/media'] },

            ]},
            {
                label: 'Obras', routerLink: ['/uikit'],
                items: [
                    ...
                    { label: 'Book', routerLink: ['/uikit/media'] },
                    { label: 'Desenhos', routerLink: ['/uikit/media'] },
